...
class YouthVisit(models.Model):
	...
	placement_date = models.DateTimeField('placement date', null=False, blank=False)
	...
	case_manager = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='+')
	personal_counselor = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, related_name='+')
